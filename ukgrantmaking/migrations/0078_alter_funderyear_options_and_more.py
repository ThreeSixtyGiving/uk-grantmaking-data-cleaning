...
def copy_funder_financial_year(apps, schema_editor):
...
def copy_funder_financial_year_reverse(apps, schema_editor):
    Funderyear = apps.get_model("ukgrantmaking", "Funderyear")
    Funderyear.objects.all().update(
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            copy_funder_financial_year,
            copy_funder_financial_year_reverse,
        ),
